...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = 'task__type_checkbox';
    editInput.type="text";
    editInput.className="task task__type_text";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task__block_edit-mode");
    ...
    listItem.classList.toggle("task__block_edit-mode");
};
